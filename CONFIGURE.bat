...
SETX TEAMSCALE_JACOCO_AGENT "D:\Teamscale\teamscale-jacoco-agent\teamscale-jacoco-agent"

:: A comma-separated list of class, jar or war files that represent the system under test.

SETX TEAMSCALE_CLASS_FILES "D:\Teamscale\teamscale-jacoco-agent\teamscale-jacoco-agent"
...
SETX TEAMSCALE_TEST_OUTPUT "D:\Teamscale\teamscale-jacoco-agent\teamscale-jacoco-agent\tempo"
