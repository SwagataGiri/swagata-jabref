SET TESTWISE_COVERAGE_REPORT=""D:\Teamscale\teamscale-jacoco-agent\teamscale-jacoco-agent\tempo\execution-127_0_0_1-8123.json""
...
SET TEAMSCALE_PROJECT=swagata_test
SET TEAMSCALE_USER=admin
SET TEAMSCALE_ACCESS_TOKEN=xX2A0KtoSth9kOWyQ07bEvohlpj9Lw6I
